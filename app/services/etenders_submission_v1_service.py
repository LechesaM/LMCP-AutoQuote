...
from app.services.etenders_submission_v1_service import run_etenders_submission

CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
PROFILE_DIR = "runtime/playwright_profiles/etenders"
...
async def run_etenders_submission(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if "etenders.gov.za" in portal_url:
        result = await run_etenders_submission(payload)
