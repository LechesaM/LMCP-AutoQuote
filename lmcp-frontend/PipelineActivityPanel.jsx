  ...
  return (
    <section className="rounded-[28px] border border-white/10 bg-slate-900/80 p-5 shadow-2xl">
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <StatCard label="Total Opportunities" value={stats.total} hint="From dashboard summary" />
        <StatCard label="Quote Ready" value={stats.quoteReady} hint="Ready for quote pipeline" />
        <StatCard label="Submitted" value={stats.submitted} hint="Already submitted" />
        <StatCard label="System Status" value={String(stats.status).toUpperCase()} hint="From system health" />
      </div>
