...
def transition_status(
    ...
    allowed = {
        QuoteStatus.DRAFT: {QuoteStatus.GENERATED, QuoteStatus.NEEDS_MANUAL_REVIEW, QuoteStatus.REJECTED},
        QuoteStatus.NEEDS_MANUAL_REVIEW: {QuoteStatus.GENERATED, QuoteStatus.PENDING_APPROVAL, QuoteStatus.REJECTED},
        QuoteStatus.GENERATED: {QuoteStatus.PENDING_APPROVAL, QuoteStatus.NEEDS_MANUAL_REVIEW, QuoteStatus.REJECTED},
        QuoteStatus.PENDING_APPROVAL: {QuoteStatus.APPROVED, QuoteStatus.REJECTED},
        QuoteStatus.APPROVED: {QuoteStatus.SENT},
        QuoteStatus.REJECTED: {QuoteStatus.DRAFT, QuoteStatus.NEEDS_MANUAL_REVIEW},
