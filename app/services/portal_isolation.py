...
class PortalIsolationManager:
    ...
    def __init__(
        self,
        state_file: str = "/Users/Shared/LMCP-AutoQuote-Server/runtime/portal_isolation_state.json",
...
portal_isolation_manager = PortalIsolationManager(
    state_file=os.getenv(
        ...
        "/Users/Shared/LMCP-AutoQuote-Server/runtime/portal_isolation_state.json",
    ),
