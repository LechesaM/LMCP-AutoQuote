...
DEFAULT_OUTPUT_DIR = _RUNTIME_DIR / "portal_submission_v47"
DEFAULT_HISTORY_PATH = _RUNTIME_DIR / "submission_history" / "v47_portal_submission_history.json"
...
def prepare_portal_submission_from_v45_workspace(
    ...
    try:
        ...
        portal_manifest = {
            ...
            # Carry upstream tender intelligence forward for V47.1/V50.7 navigation.
            "title": manifest.get("title"),
            "description": manifest.get("description"),
            "raw_text": manifest.get("raw_text"),
            "source_url": manifest.get("source_url"),
            "opportunity_url": manifest.get("opportunity_url"),
            "detail_url": manifest.get("detail_url"),
            "document_url": manifest.get("document_url"),
            "download_url": manifest.get("download_url"),
            "tender_id": manifest.get("tender_id"),
            "tender_no": manifest.get("tender_no"),
            "supportDocumentID": manifest.get("supportDocumentID"),
