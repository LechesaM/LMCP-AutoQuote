...
OPERATOR_AUTH_DB = Path(os.getenv("LMCP_OPERATOR_AUTH_DB_PATH", str(RUNTIME_DIR / "operator_auth" / "operator_auth.sqlite3"))).expanduser()
OPERATOR_AUTH_DIR = OPERATOR_AUTH_DB.parent
OPERATOR_SESSION_COOKIE_NAME = os.getenv("LMCP_OPERATOR_SESSION_COOKIE_NAME", "lmcp_operator_session")
OPERATOR_SESSION_TIMEOUT_SECONDS = max(300, int(os.getenv("LMCP_OPERATOR_SESSION_TIMEOUT_SECONDS", "28800") or "28800"))
OPERATOR_SESSION_COOKIE_SECURE = str(os.getenv("LMCP_OPERATOR_SESSION_COOKIE_SECURE", "")).strip().lower() in {"1", "true", "yes", "on"}
OPERATOR_AUTH_ALLOW_DEV_FALLBACK = str(os.getenv("LMCP_OPERATOR_AUTH_ALLOW_DEV_FALLBACK", "")).strip().lower() in {"1", "true", "yes", "on"}
