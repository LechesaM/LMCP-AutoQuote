...
def get_system_health() -> Dict[str, Any]:
    ...
    components: List[Dict[str, Any]] = [
        ...
        },
        {
            ...
            "details": {
                "states": len(
                    workflow_state_engine._STATE_BY_FILE.get(
                        str(workflow_state_engine.WORKFLOW_STATE_LOG_FILE),
                        {},
                    )
                )
            },
        },
        {
            ...
            "status": "healthy",
            "details": {"audit_file_present": audit_trail_service.AUDIT_FILE.exists()},
        },
        {
            "component": "router_registry",
            "status": "healthy",
            "details": {"routers": len(list(iter_router_specs()))},
        },
        {
            "component": "persistence",
            "status": get_persistence_health().get("status", "healthy"),
            "details": get_persistence_health(),
        },
    ]
