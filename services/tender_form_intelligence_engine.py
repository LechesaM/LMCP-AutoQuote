...
RUNTIME_DIR = RUNTIME_ROOT / "tender_form_intelligence"
...
def _resolve_path(path_value: Union[str, Path, None]) -> Optional[Path]:
    ...
    if "/runtime/" in raw:
        ...
        candidates.append(RUNTIME_ROOT / tail)
...
def _signature_candidates(path_value: Any) -> List[Path]:
    ...
    dirs = [
        RUNTIME_ROOT / "handwriting_simulation",
...
def example_payload() -> Dict[str, Any]:
    return {
        ...
        "input_pdf": str(RUNTIME_ROOT / "playwright" / "downloads" / "RFQ_Corporate_Gift_Packs.pdf"),
        "signature_image": str(RUNTIME_ROOT / "handwriting_simulation" / "sample_signature.png"),
        "ink_color": "black",
        "debug": True,
    }
