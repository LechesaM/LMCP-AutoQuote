"""
FastAPI router for LMCP Clean Ink Extraction V3

Drop-in path:
    app/api/clean_ink_extraction_v3_api.py

Add to app/main.py:
    from app.api.clean_ink_extraction_v3_api import router as clean_ink_extraction_v3_router
    app.include_router(clean_ink_extraction_v3_router)

Endpoints:
    GET  /clean-ink-v3/status
    POST /clean-ink-v3/extract
    POST /clean-ink-v3/extract-latest
"""
...
class CleanInkExtractRequest(BaseModel):
    ...
    job_id: Optional[str] = Field(default=None, description="Optional clean job id")
