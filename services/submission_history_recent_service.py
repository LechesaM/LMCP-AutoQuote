...
HISTORY_CANDIDATES = [
    RUNTIME_DIR / "submission_history" / "submission_history.json",
    RUNTIME_DIR / "submissions" / "submission_history.json",
    RUNTIME_DIR / "submission_scheduler" / "submission_history.json",
