...
class DiskSafetyStatus:
    ...
    harvester_pause_file: str = "runtime/harvester.paused"
    lock_file: str = "runtime/disk_guard.lock"
...
class DiskSafetyGuard:
    ...
    def __init__(
        ...
        self.pause_file = os.path.join(self.project_root, "runtime", "harvester.paused")
        self.lock_file = os.path.join(self.project_root, "runtime", "disk_guard.lock")
