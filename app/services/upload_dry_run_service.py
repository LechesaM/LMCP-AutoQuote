...
COMPLETED_FORMS_DIR = Path("runtime/tender_form_intelligence/completed_forms")
...
GLOBAL_ARTIFACT_ROOTS = [
    ...
    Path("runtime/quote_pack_v44"),
    Path("runtime/submission_pack_v45"),
    Path("runtime/auto_submission_v46"),
    Path("runtime/portal_submission_v47"),
    Path("runtime/rfq_boq_extraction"),
    Path("runtime/rfq_document_acquisition"),
    Path("runtime/tender_document_acquisition"),
    Path("runtime/rfq_document_intelligence"),
    Path("runtime/rfq_docx_main_document_intelligence"),
    Path("runtime/multi_portal_discovery/documents"),
    COMPLETED_FORMS_DIR,
]
