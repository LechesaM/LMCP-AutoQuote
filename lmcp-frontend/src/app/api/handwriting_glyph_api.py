...
def handwriting_glyph_status() -> Dict[str, Any]:
    return {
        "status": "ok",
        "service": "handwriting_glyph_engine_v2",
        "message": "Ready to use smart extracted handwriting glyphs on existing PDF forms.",
...
def handwriting_glyph_example_payload() -> Dict[str, Any]:
    return {
        "status": "ok",
        "payload": {
            "buyer_rfq_number": "REAL-SBD-TEST-002",
            ...
            "fields": [
                ...
                {"page": 1, "x": 120, "y": 690, "text": "Lechesa Manaba", "glyph_height": 15},
                {"page": 1, "x": 120, "y": 660, "text": "Director", "glyph_height": 15},
                {"page": 1, "x": 400, "y": 660, "text": "2026-04-25", "glyph_height": 13},
            ],
        },
    }
