...
class Settings:
    ...
    project_root: Path = Path(_env("LMCP_PROJECT_ROOT", str(BASE_DIR))).expanduser().resolve()
    runtime_dir: Path = Path(_env("LMCP_RUNTIME_DIR", str(BASE_DIR / "runtime"))).expanduser().resolve()
