...
DEFAULT_OUTPUT_DIR = RUNTIME_DIR / "full_autonomous_v48"
DEFAULT_STATE_PATH = RUNTIME_DIR / "system_control" / "v48_autonomous_state.json"
DEFAULT_HISTORY_PATH = RUNTIME_DIR / "submission_history" / "v48_autonomous_runs.json"
...
def _resolve_path(value: str | Path) -> Path:
    ...
    if raw.startswith("runtime/"):
        return RUNTIME_DIR / raw[len("runtime/") :]
