...
nohup bash -lc "cd frontend && LMCP_BACKEND_URL='${BACKEND_URL}' VITE_LMCP_API_BASE_URL='${BACKEND_URL}' npm run dev -- --host 127.0.0.1 --port '${FRONTEND_PORT}' --strictPort" >"${FRONTEND_LOG}" 2>&1 &
FRONTEND_PID=$!
