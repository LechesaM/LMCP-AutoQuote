        ...
        <div className="proof-audit-drawer-body">
          {activeTab === "Overview" ? (
            <div className="proof-audit-detail-grid">
              ...
              <div className="proof-audit-detail-card"><span>Indexed</span><b>{proof.proof_file ? "Yes" : "No"}</b></div>
              <div className="proof-audit-detail-card"><span>Proof File</span><b>{proof.proof_file || "—"}</b></div>
